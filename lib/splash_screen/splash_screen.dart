       ...
       children: [
         ...
         Center(
           child: Column(
             ...
             children: [
               Image.asset('assets/images/splash_img_plate.png',height: 200,width: 200,),
               const SizedBox(height: 8,),
               const Text('Cook Book',style: TextStyle(color: Colors.black,fontWeight: FontWeight.w500,fontSize: 22),),
